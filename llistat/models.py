...
class CSVData(models.Model):
    ...
    Peticionario = models.CharField(max_length=20, null=True, blank=True)
    Factibilidad = models.IntegerField(null=True, blank=True)
    Plazo = models.DateField(null=True, blank=True)
    Cerrado = models.BooleanField()
    Fecha_Cierre = models.DateField(null=True, blank=True)
    Tarea = models.IntegerField(null=True, blank=True)
    ...
    PCP_Lock = models.CharField(max_length=10, null=True, blank=True)
    ...
    PROG_MRP = models.CharField(max_length=8, null=True, blank=True)
